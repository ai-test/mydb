...
<div class="container">
    ...
    <div class="well bs-component">
        ...
        <form action="<?php echo U('Index/password');?>" method="post" class="form-horizontal" id="password-form">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <div class="form-control-wrapper">
                            <input type="password" name="new-password" class="form-control empty" autocomplete="off"/>
                            <span class="material-input"></span>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <div class="form-control-wrapper">
                            <input type="password" name="re-password" class="form-control empty" autocomplete="off"/>
                            <span class="material-input"></span>
                        </div>
                    </div>
                </div>
